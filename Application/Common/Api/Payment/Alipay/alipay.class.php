...
// +----------------------------------------------------------------------
// | Date: 2016-07-11 15:03
// +----------------------------------------------------------------------
namespace Common\Api\Payment\Alipay;
/**
 * 支付宝接口类
 */
class alipay{
    ...
    public function get_payurl(){
    	$this->parameter = array(
            ...
            'notify_url'	    => 'http://localhost/mxsh/Home/Payment/notifyUrl',	//通知URL
            'sign_type'		    => 'MD5',				//签名方式
            'return_url'	    => 'http://localhost/mxsh/Home/Payment/returnUrl',	//返回URL
