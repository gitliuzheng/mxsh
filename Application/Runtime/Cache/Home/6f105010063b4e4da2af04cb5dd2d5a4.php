...
<html class="yui3-js-enabled" id="yui_3_16_0_1_1465960232707_233">
<head>
    ...
    <link charset="utf-8" rel="stylesheet" href="/Public/CSS/cart.css">
...
<div class="table-section summary-table" id="yui_3_16_0_1_1467448101261_379">
    <table cellspacing="0" id="yui_3_16_0_1_1467448101261_378">
        <tbody id="yui_3_16_0_1_1467448101261_377"><tr>
            <th width="60">
        ...
        <?php if(is_array($cart)): $i = 0; $__LIST__ = $cart;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="yui_3_16_0_1_1467448101261_1140">
                <td colspan="6" class="cartItem" id="yui_3_16_0_1_1467448101261_1139">
                    <table cellspacing="0" id="yui_3_16_0_1_1467448101261_1138">
                        <tbody id="yui_3_16_0_1_1467448101261_1137"><tr id="yui_3_16_0_1_1467448101261_1136">
                            ...
                            <td width="150" class="saleNum deal-component-quantity" id="yui_3_16_0_1_1467448101261_1135">
                                <div data-component="cart-quantity" class="component-cart-quantity mt-component--booted" mt-scope="[&quot;quantity=cartItems.26263695_0.list.0.quantity&quot;,&quot;onchange=onQuantityChange&quot;]" data-component-params="{&quot;dealid&quot;:26263695,&quot;calendarid&quot;:0,&quot;dealgoodsid&quot;:0,&quot;minNumPerOrder&quot;:1,&quot;maxNumPerOrder&quot;:0,&quot;remain&quot;:100,&quot;totalRemain&quot;:null}" data-component-config="{&quot;lazyRender&quot;:false}" id="yui_3_16_0_1_1467448101261_96"><div class="cart-quantity">
                                    <button class="minus" data-action="-" gaevent="top/minus" type="button" mt-bind-onclick="decrease()">-</button><input type="text" autocomplete="off" class="f-text J-quantity J-cart-quantity" maxlength="4" mt-bind-onkeyup="keyup($event)" mt-bind-value="quantity" value="<?php echo ($vo["goods_count"]); ?>"><button for="J-cart-add" class="item plus" data-action="+" gaevent="top/plus" type="button" mt-bind-onclick="increase()">+</button>
                                </div>
                                </div>
                            </td>
                        ...
                        <input type="hidden" class="J-cartItem-quantity" name="quantity-26263695-0" mt-bind-value="cartItems.26263695_0.quantity" value="1">
                        </tbody></table>
                </td>
