...
<body class="pg-floor-new-v2" style="position: static;" onkeydown='onEnterDown();'>
...
<!-- 关键字搜索  zhangkuan -->  
    <form  class="search-box__form J-search-form cf"  name="searchForm" method="get" >
        ...
        <input tabindex="1" type="text"   autocomplete="off" data-smartbox="/search/smartboxv2/" class="s-text search-box__input J-search-box__input" value="" placeholder="请输入商品名称、地址等" id="yui_3_16_0_1_1464999326260_132" class="name">
...
<!-- 热门搜索 -->
    <div class="J-search-box__hot search-box__hot log-mod-viewed" data-mod="st" id="yui_3_16_0_1_1464999326260_9573">
                            ...
                            <?php static $k = 0; if($k>=9){break;} $k++; ?>
                                <div class="J-nav-item" id="yui_3_16_0_1_1464999326260_12113">
                                    <div class="cate-nav__item J-cate-nav__item--1 cate-nav__item--1 cate-nav__item--has-l2 " id="yui_3_16_0_1_1464999326260_749">
                                        ...
                                        <!-- 特效尺寸调整 -->
                                        <div class="nav-level2 J-nav-level2 nav-waterfall" data-level1="1" style="visibility: visible; top: <?php echo 0 - 52 * ($k-1);?>px; display: none;" hidden="hidden">
...
<div class="content__cell content__cell--geo J-filter__geo content__cell-small" id="yui_3_16_0_1_1464999326260_8804">
    ...
    <li class="deal-list--hots mt-slider-sheet" style="left: 0px;" id="yui_3_16_0_1_1464999326260_9561">
        <div data-component="deal-list" class="component-deal-list mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1464999326260_9548">    
            
<!-- 名店抢购 -->
        <?php if(is_array($xianshi_item)): $i = 0; $__LIST__ = $xianshi_item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; static $k3 = 0; if($k3>=5){break;} $k3++; ?>
            <div class="deal-tile" data-mttcode="C1">
                <a href="<?php echo U('Home/Index/deal/id/'.$vo['goods_id'], '', FALSE);?>" class="deal-tile__cover" hidefocus="true" target="_blank">
                ...
                <h3 class="deal-tile__title">
                    <a href="http://suzhousz.meituan.com/deal/33657254.html" class="w-link" title="皇家美幻蛋糕店" hidefocus="true" target="_blank">
                        <span class="xtitle"><?php echo ($vo["goods_name"]); ?></span>
                        <span class="short-title">淡奶油蛋糕1个，约10寸，圆形</span>
                    </a>
                </h3>
                <p class="deal-tile__detail">
                    <span class="price">¥<strong><?php echo ($vo["xianshi_price"]); ?></strong></span>
