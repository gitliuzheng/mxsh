...
<html class="yui3-js-enabled" id="yui_3_16_0_1_1465867114754_808">
<head>
...
<meta name="description" content="美团网宿州团购大全,专业美食团购,酒店团购，电影团购，KTV团购等齐全的宿州团购网站,宿州团购导航，上宿州美团网,更多超值打折优惠团购大全信息等你来">

<meta name="keywords" content="宿州团购大全, 宿州团购网站大全,宿州团购导航,宿州团购网站">
...
<link rel="canonical" href="http://suzhousz.meituan.com/category">
...
<link rel="stylesheet" type="text/css" href="/Public/CSS/category_saved_resource(5).css">
<link charset="utf-8" rel="stylesheet" href="/Public/CSS/category_saved_resource(6).css">
<link charset="utf-8" rel="stylesheet" href="/Public/CSS/category_saved_resource(13).css">
<noscript hidden="" style="display:none;" class="J-hub" data-hublaziness="load" data-hubcss="fewww:www/css/lazyload.css,iconfont/css/global-iconfont.css@b64babf" data-hubstamp="yui_3_16_0_1_1465867114754_346" data-hubstate="40"></noscript>
</head>
<body class="pg-index" id="yui_3_16_0_1_1465867114754_13" style="position: static;">
...
<div data-component="filter-section" class="component-filter-section mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_343">
    <div id="filter">
        <div class="filter-sortbar-outer-box filter-main--attrs" id="yui_3_16_0_1_1465867114754_807">       
            <div class="filter-section-wrapper" id="yui_3_16_0_1_1465867114754_806">
                <div data-component="filter-category" class="component-filter-category mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_345">                
                        ...
                        <!-- 如果Url中有二级与三级分类，分类行不显示，删除行显示二级分类与三级分类 -->
                            <div class="filter-label-list filter-section category-filter-wrapper first-filter">
                                ...
                                <!-- 二级分类 -->
                                    ...
                                    <a href="/index.php/Home/Search/category">X</a>    
                                <!-- 三级分类 -->
                                    <li class="item"> <?php echo ltrim(strstr($gc_id3, '-'), '-'); ?></li>
                                    <a href="/index.php/Home/Search/category/gc_id/<?php echo $gc_id ?>">X</a>                                            
                                </ul>
                            </div>  
                        <?php }else if($gc_id){ ?>
                            ...
                            <div id="search_condition">                
                                <div class="filter-label-list filter-section category-filter-wrapper first-filter">
                                    ...
                                    <ul class="inline-block-list">
                                        ...
                                        <?php if(is_array($gClass)): $i = 0; $__LIST__ = $gClass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><li class="item"><a href="/index.php/Home/Search/category/gc_id/<?php echo $gc_id ?>/gc_id3/<?php echo $v1['gc_id']; ?>-<?php echo $v1['gc_name']; ?>"><?php echo ($v1['gc_name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>                                        
                                    </ul>
                                </div>
                            </div>
                        <?php }else{ ?>
                        <!-- 如果Url中没有二级与三级分类并且不是关键字查询，分类行显示二级分类 -->
                                ...
                                <div id="search_condition">                
                                    <div class="filter-label-list filter-section category-filter-wrapper first-filter">
                                        ...
                                        <ul class="inline-block-list">
                                            <li class="item current"><a class="briber" href="#">全部</a></li>                                       
                                            <?php if(is_array($fClass)): $i = 0; $__LIST__ = $fClass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><li class="item"><a href="/index.php/Home/Search/category/gc_id/<?php echo $v1['gc_id']; ?>-<?php echo $v1['gc_name']; ?>"><?php echo ($v1['gc_name']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </ul>
                                    </div>
                                </div>
                                <?php } else{?>
...
<!-- zhangkuan -->
                ...
                <div data-component="filter-geo" class="component-filter-geo mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_705">    

    <!-- <div class="filter-label-list filter-section geo-filter-wrapper" id="yui_3_16_0_1_1465867114754_11">
        ...
        <ul class="inline-block-list J-filter-list filter-list--fold">
                <li class="item current">
                        <a href="http://suzhousz.meituan.com/category/">全部</a>
                </li>
                <li class="item">
                        <a href="http://suzhousz.meituan.com/category/all/qiaoqu">埇桥区</a>
                </li>
                <li class="item">
                        <a href="http://suzhousz.meituan.com/category/all/dangshanxian">砀山县</a>
                </li>
                <li class="item">
                        <a href="http://suzhousz.meituan.com/category/all/xiaoxian">萧县</a>
                </li>
                <li class="item">
                        <a href="http://suzhousz.meituan.com/category/all/lingbixian">灵璧县</a>
                </li>
                <li class="item">
                        <a href="http://suzhousz.meituan.com/category/all/sixian">泗县</a>
                </li>
        </ul>
    </div> -->
</div>
...
<!-- 按条件排序    zhangkuan-->
<!-- 点击后调用Common/function中的fUrl方法 -->
        <div data-component="filter-sort" class="component-filter-sort mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_707">
            <div class="filter-sortbar">
                <div class="button-strip inline-block">
                    <a href="<?php  echo fUrl('odby','p'); ?>" title="默认排序" class="button-strip-item inline-block button-strip-item-right button-strip-item-checked">
                        <span class="inline-block button-outer-box">
                            <span class="inline-block button-content">默认</span>
                        </span>
                    </a>
                    <a href="<?php  echo fUrl('odby','p'); ?>/odby/xl" title="销量从高到低" class="button-strip-item inline-block button-strip-item-left button-strip-item-right button-strip-item-desc" rel="nofollow">
                        <span class="inline-block button-outer-box">
                            <span class="inline-block button-content">销量</span><span class="inline-block button-img"></span>
                        </span>
                    </a>
                    <a href="<?php  echo fUrl('odby','p'); ?>/odby/jg" title="价格从低到高" class="button-strip-item inline-block button-strip-item-left button-strip-item-right button-strip-item-asc" rel="nofollow">
                        <span class="inline-block button-outer-box">
                            <span class="inline-block button-content">价格</span><span class="inline-block button-img"></span>
                        </span>
                    </a>
                    <a href="<?php  echo fUrl('odby','p'); ?>/odby/hp" title="评分从高到低" class="button-strip-item inline-block button-strip-item-left button-strip-item-right button-strip-item-desc" rel="nofollow">
                        <span class="inline-block button-outer-box">
                            <span class="inline-block button-content">好评</span><span class="inline-block button-img"></span>
                        </span>
                    </a>
                    <a href="<?php  echo fUrl('odby','p'); ?>/odby/sj" title="发布时间从新到旧" class="button-strip-item inline-block button-strip-item-left button-strip-item-desc" rel="nofollow">
                        <span class="inline-block button-outer-box">
                            <span class="inline-block button-content">发布时间</span><span class="inline-block button-img"></span>
                        </span>
                    </a>
                </div>   
            </div>
...
<div id="sidebar" class="site-sidebar" data-comboajax-uri="/index/sidebar/all" data-comboajax-onsuccess="this.removeClass(&quot;lazy-render&quot;).removeClass(&quot;lazy-container&quot;).prepend($response.html)" data-comboajax-state="5"><div class="side-extension side-extension--multiple side-extension--download"><a href="http://www.meituan.com/mobile" target="_blank" hidefocus="true" gaevent="sidebar/mobile" class="side-extension__item side-extension__item--client log-mod-viewed" data-mod="rm"></a><a href="http://maoyan.com/" target="_blank" hidefocus="true" gaevent="sidebar/dianying" class="side-extension__item side-extension__item--movie side-extension__item--last log-mod-viewed" data-mod="ry"></a></div><div data-component="top-deals" class="component-top-deals mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false}" id="yui_3_16_0_1_1465867114754_2058"><div class="side-extension mall--small top-reco-deals cf log-mod-viewed" data-mod="ih" data-mtnode="Alist.Bmostbuy.D0">
    <h3>猜你喜欢</h3>



        <div class="deal-tile--small " data-mttcode="Aresys.Bfilterrightside.G1.F32806765.H.CcfRec.DcfRec">
        <a class="deal-tile--small__cover" href="http://www.meituan.com/deal/32806765.html" gaevent="list/mostbuy/all/1/photo" target="_blank" hidefocus="true" rel="nofollow" title="【全国】正新鸡排单人餐">
            <img class="" width="198" height="120" src="/Public/category_files/df8df7d29e80b8e25849058543ce5d2636614.jpg@3_0_684_415a-388h_640w_2e_90Q">                        <span class="deal-rank">1</span>
                    </a>
        <h4 class="deal-tile--small__title">
            <a class="w-link link--black__green f1" href="http://www.meituan.com/deal/32806765.html" gaevent="list/mostbuy/all/1/title" target="_blank" hidefocus="true" rel="nofollow" title="【全国】正新鸡排单人餐">
                【全国】正新鸡排单人餐            </a>
        </h4>
        <p class="deal-tile--small__detail">
            <span class="price num">¥<strong>8.9</strong></span>
            <span class="sales f1">已售<strong class="num">3715533</strong></span>
        </p>
    </div>
    ...
    <ul class="history-list J-history-list">
        <li class="history-list__item history-list__item--first" target="_blank" ref="nofollow"><img class="" src="/Public/category_files/26c9f4e50185c4891ac74370b74a9853151923.jpg" width="80" height="50">
        <h5>
        ...
        <li class="history-list__item" target="_blank" ref="nofollow"><img class="" src="/Public/category_files/0af5e66e4363eb528f0442444f771eb7179883.jpg" width="80" height="50">
        <h5>
        ...
        <li class="history-list__item" target="_blank" ref="nofollow"><img class="" src="/Public/category_files/aa63c620ca11691e6cbdd985c855d58d534450.jpeg" width="80" height="50">
        <h5>
        ...
        <li class="history-list__item" target="_blank" ref="nofollow"><img class="" src="/Public/category_files/0883cf75eef1bfeb328a891b3e85ff1c139686.jpg" width="80" height="50">
        <h5>
        ...
        <li class="history-list__item history-list__item--last" target="_blank" ref="nofollow"><img class="" src="/Public/category_files/1bdb7273e684a5d996f2cf69e31340d4121016.jpg" width="80" height="50">
        <h5>
...
<!-- 所有商品列表及分页          zhangkuan  -->
<div id="content" class="mall mall--fixed cf J-mall log-mod-viewed" data-mod="id" data-mteventnd="{&quot;la&quot;:&quot;deal\/see&quot;,&quot;tf&quot;:&quot;all&quot;,&quot;geo&quot;:&quot;all&quot;,&quot;st&quot;:&quot;default&quot;,&quot;pg&quot;:1,&quot;rs&quot;:&quot;undefined&quot;}">
    <div class="J-scrollloader cf J-hub" data-hubmodule="www-index" data-hubnamespace="Index.DealList" data-hubconfig="true" data-async-params="{&quot;action&quot;:&quot;\/index\/deallistv2&quot;,&quot;data&quot;:{&quot;params&quot;:{&quot;mteventParams&quot;:{&quot;la&quot;:&quot;deal\/see&quot;,&quot;tf&quot;:&quot;all&quot;,&quot;geo&quot;:&quot;all&quot;,&quot;st&quot;:&quot;default&quot;,&quot;pg&quot;:1,&quot;rs&quot;:&quot;undefined&quot;}},&quot;categorySlug&quot;:&quot;all&quot;,&quot;geoSlug&quot;:&quot;all&quot;,&quot;geotype&quot;:&quot;all&quot;,&quot;areaid&quot;:&quot;all&quot;,&quot;districtid&quot;:&quot;all&quot;},&quot;initialLoad&quot;:36}" data-hubstamp="yui_3_16_0_1_1465867114754_396" data-hubstate="40" id="yui_3_16_0_1_1465867114754_446">                
        <div data-component="deal-list" class="component-deal-list mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_709">
        <?php if($data){?>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="deal-tile" data-mteventnd="{&quot;id&quot;:27962815,&quot;pos&quot;:1}" id="yui_3_16_0_1_1465867114754_10270">
                    <a href="<?php echo U('Home/Index/deal/id/'.$v['goods_id'], '', FALSE);?>" class="deal-tile__cover" hidefocus="true" target="_blank" data-mtevent="{&quot;sr&quot;:&quot;cover&quot;}" id="yui_3_16_0_1_1465867114754_10269">
                        <img class="J-webp" width="350" height="214" alt="<?php echo ($v["goods_name"]); ?>" src="/Public/category_files/aa63c620ca11691e6cbdd985c855d58d534450(1).jpeg" onload="M.logFirstScreenTime(this)" id="yui_3_16_0_1_1465867114754_10268">
                        <span class="deal-mark">
                                <span class="deal-mark__item deal-mark__item--nnbooking" title="免预约">免预约</span>
                        </span>
                    </a>
                    <h3 class="deal-tile__title" id="yui_3_16_0_1_1465867114754_10319">
                        <a href="<?php echo U('Home/Index/deal/id/'.$v['goods_id'], '', FALSE);?>" class="w-link" title="国色天乡三期陆地乐园" hidefocus="true" target="_blank" data-mtevent="{&quot;sr&quot;:&quot;title&quot;}" id="yui_3_16_0_1_1465867114754_10318">
                            <span class="xtitle" id="yui_3_16_0_1_1465867114754_10317">&nbsp;&nbsp;<?php echo ($v["goods_name"]); ?></span>
                            <span class="short-title" id="yui_3_16_0_1_1465867114754_10320">无需预约</span>
                        </a>
                    </h3>
                    ...
                    <div class="deal-tile__extra" id="yui_3_16_0_1_1465867114754_10322">
                        <p class="extra-inner" id="yui_3_16_0_1_1465867114754_10321">
                            <span class="sales">
                                已售<strong class="num"><?php echo ($v["goods_salenum"]); ?></strong>
                            </span>
                            <a href="http://www.meituan.com/deal/27962815.html#anchor-reviews" class="rate-info" hidefocus="true" target="_blank" data-mtevent="{&quot;sr&quot;:&quot;rating&quot;}">
                                <span class="rate-info__bar common-rating">
                                    <span class="rate-stars" style="width: 88%;"></span>
                                </span>
                                <span class="rate-info__count"><?php echo ($v["evaluation_count"]); ?>人评价</span>
                            </a>
                        </p>
                    </div>
    ...
    <div class="deals-async-loading" hidden="hidden" style="display: none;">
        <div class="deals-async-loading__tips"><i></i>加载中</div>
    </div>            
    <div class="paginator-wrapper">
        <ul class="paginator paginator--notri paginator--large"><?php echo ($page); ?></ul>
    </div>
</div>
<!-- zhangkuan 123-->
...
<div data-component="qrcode-stick" class="component-qrcode-stick mt-component--booted" mt-scope="[]" data-component-config="{&quot;lazyRender&quot;:false,&quot;afterLoad&quot;:false}" id="yui_3_16_0_1_1465867114754_711"><div class="stick-qrcode J-hub" data-module="www-base" data-hubnamespace="StickQrcode" data-hubconfig="{&quot;vTopOffset&quot;:100,&quot;vBottomOffset&quot;:200}" style="display:none;" data-hubstamp="yui_3_16_0_1_1465867114754_421" data-hubstate="40">
    <a class="index-xiaomei" href="http://suzhousz.meituan.com/mobile/down/homepmt" hidefocus="true">
        <span class="stick-qrcode__pos stick-qrcode-index"></span>
        <span class="close"></span>
    </a>
</div>
</div>

<noscript hidden="" style="display:none;" data-comboajax-uri="/index/tips/index/default" data-comboajax-onsuccess="$request.listen(&quot;www-tips&quot;, &quot;www.Tips&quot;);" data-comboajax-data="{&quot;sysmsg&quot;:true,&quot;commontips&quot;:true,&quot;page&quot;:&quot;index&quot;}" data-comboajax-state="5" data-parent="#bd"></noscript>
<noscript hidden="" style="display:none;" data-comboajax-uri="/index/prepare" data-comboajax-onsuccess="$request.listen(&quot;www-index&quot;, &quot;www.Index.FloatCard&quot;);" data-comboajax-state="5"></noscript>

        </div>
    </div><div id="yui3-css-stamp" style="position: absolute !important; visibility: hidden !important" class=""></div>

    <div data-component="holy-reco" class="component-holy-reco mt-component--booted" mt-scope="[]" data-component-config="{&quot;css&quot;:&quot;fewww:\/www\/css\/holy-reco.css@b64babf&quot;}" id="yui_3_16_0_1_1465867114754_713"><div class="J-holy-reco holy-reco">
    <div>
        ...
        <div class="J-holy-reco__content holy-reco__content">
            <a href="http://suzhousz.meituan.com/category/meishi" title="美食团购">餐饮美食</a>
            <a href="http://suzhousz.meituan.com/dianying/" title="电影团购">酒店宾馆</a>
            <a href="http://suzhousz.meituan.com/category/xuxianyule" title="休闲娱乐团购">休闲娱乐</a>
            <a href="http://suzhousz.meituan.com/category/lvyou" title="旅游团购">生活服务</a>
            <a href="http://suzhousz.meituan.com/category/shenghuo" title="生活服务团购">丽人</a>
            <a href="http://suzhousz.meituan.com/category/wanggou" title="购物团购">家居家装</a>
            <a href="http://suzhousz.meituan.com/category/jiangkangliren" title="丽人团购">服饰箱包</a>
            <a href="http://ch.meituan.com/category/youle" title="巢湖景点郊游">巢湖景点郊游</a>
            ...
            <a href="http://ch.meituan.com/category/yunguicai" title="巢湖云贵菜">巢湖云贵菜</a>
            <a href="http://ch.meituan.com/category/zizhucan" title="巢湖自助餐">巢湖自助餐</a>
            <a href="http://ch.meituan.com/category/muyingqinzi" title="巢湖母婴亲子">巢湖母婴亲子</a>
            <a href="http://ch.meituan.com/category/shipinyinliao" title="巢湖食品饮料">巢湖食品饮料</a>
            <a href="http://ch.meituan.com/category/kaorou" title="巢湖烧烤烤肉">巢湖烧烤烤肉</a>
            <a href="http://ch.meituan.com/category/kafeijiuba" title="巢湖咖啡酒吧">巢湖咖啡酒吧</a>
            <a href="http://ch.meituan.com/category/4d5d" title="巢湖4D/5D电影">巢湖4D/5D电影</a>
            <a href="http://ch.meituan.com/category/sushi" title="巢湖素食">巢湖素食</a>
            <a href="http://ch.meituan.com/category/huaxue" title="巢湖滑雪">巢湖滑雪</a>
            <a href="http://ch.meituan.com/category/haohuajiudian" title="巢湖豪华酒店">巢湖豪华酒店</a>
            <a href="http://ch.meituan.com/category/xican" title="巢湖西餐">巢湖西餐</a>
            <a href="http://ch.meituan.com/category/jingdianmenpiao" title="巢湖景点门票">巢湖景点门票</a>
            <a href="http://ch.meituan.com/category/aiche" title="巢湖汽车服务">巢湖汽车服务</a>
            <a href="http://ch.meituan.com/category/qitashenghuo" title="巢湖其他生活">巢湖其他生活</a>
            <a href="http://ch.meituan.com/category/dongbeicai" title="巢湖东北菜">巢湖东北菜</a>
            ...
            <a href="http://ch.meituan.com/category/muying" title="巢湖玩具/母婴">巢湖玩具/母婴</a>
            <a href="http://suzhousz.meituan.com/category/style=%22display:none%22" title="style">style</a>
        </div>
</div></div>
    ...
    <footer class="site-info-w J-br" style="min-height:298px;" id="yui_3_16_0_1_1465867114754_228">
...
<div data-component="rightbottom-sticky" class="component-rightbottom-sticky mt-component--booted" mt-scope="[]" data-component-config="{&quot;css&quot;:&quot;fewww:\/www\/css\/rightbottom-sticky.css@b64babf&quot;}" id="yui_3_16_0_1_1465867114754_715" style="bottom: 20px; right: 10px;"><div id="fixbar-container" class="new-index-triffle-w" data-config="{&quot;feedbackConfig&quot;:{&quot;url&quot;:&quot;\/vote\/survey\/59&quot;,&quot;ga&quot;:&quot;feedback\/search&quot;}}" style="bottom: 20px; right: 10px;">
    ...
    <div id="fixbar-item-vote" style="bottom: 20px; right: 10px;">
        <a target="_blank" class="new-index-triffle lift-nav lift-nav--vote" hidefocus="true" href="http://survey.meituan.com/index.php?r=survey/index/sid/924516/lang/zh-Hans"><i></i><span>问卷调查</span></a>
    </div>
    ...
    <div id="fixbar-item-feedback" style="bottom: 20px; right: 10px;"><a target="_blank" class="new-index-triffle lift-nav lift-nav--feedback" hidefocus="true" gaevent="feedback/search" href="http://suzhousz.meituan.com/vote/survey/59"><i></i><span>意见反馈</span></a></div>
</div></div>
